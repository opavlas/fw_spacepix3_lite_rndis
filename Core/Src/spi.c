...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE BEGIN SPI1_MspInit 0 */
	  // not great but when CUBE is generating code from .ioc file this define are not decleared, dont know why ??
#define TRANSFERALLOCATEDPORTSRC_GPDMACH0 0x00000000U
#define TRANSFERALLOCATEDPORTDEST_GPDMACH0 0x00000000U
  ...
  */
    ...
    */
    ...
    handle_GPDMA1_Channel0.Init.TransferAllocatedPort = TRANSFERALLOCATEDPORTSRC_GPDMACH0|TRANSFERALLOCATEDPORTDEST_GPDMACH0;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PD3     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_4|GPIO_PIN_3);
...
/* USER CODE BEGIN 1 */
void MX_SPI2_Init_user(uint8_t clock_freq)
{
  ...
  /* USER CODE BEGIN SPI2_Init 1 */
  unsigned long prescaler = SPI_BAUDRATEPRESCALER_2;
  log_debug("Prescaler: %d",clock_freq);
	switch (clock_freq) {
		case Frequency120:
			break;
		case Frequency100:
